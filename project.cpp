...
//only for audio-----------------------------	
    ...
    const char* audioFilePath = "D:\\Thanks.mp3";  // Ensure this is the correct path and file extension
...
//only for audio-----------------------------	
	// Specify the path to your audio file
    const char* audioFilePath = "D:\\welcome.mp3";  // Ensure this is the correct path and file extension
...
//only for audio-----------------------------
    ...
    while (true) {
        ...
        SetConsoleTextAttribute(hConsole, FOREGROUND_RED | FOREGROUND_GREEN | FOREGROUND_BLUE);
		cout << " -Press ""1"" to Report a crime\n";
